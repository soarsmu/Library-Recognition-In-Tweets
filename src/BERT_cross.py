...
if __name__ == '__main__':
    ...
    init_logger('../log/cross_{}_{}.log'.format(variant, datetime.datetime.today().strftime('%Y-%m-%d-%H:%M:%S')))
    ...
    for i in range(k):
        ...
        os.makedirs('../model/cross/', exist_ok=True)
        model_save_path = '../model/cross/{}_{}_{}.pt'.format(variant, test_fold_num, seed)
    ...
    logging.info('============ The averaged performance ======== ')
