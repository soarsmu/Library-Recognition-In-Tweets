...
if __name__ == '__main__':
    ...
    init_logger('../log/{}_{}.log'.format(args.variant, datetime.datetime.today().strftime('%Y-%m-%d-%H:%M:%S')))
    ...
    for i in range(k):
        ...
        model_save_path = '../model/stratified/{}_{}_{}.pt'.format(args.variant, test_fold_num, seed)
        ...
        train_texts, val_texts, train_labels, val_labels = train_test_split(train_texts, train_labels, \
            test_size=0.1, random_state=seed, stratify=train_labels)
